...
| 平台 | 仓库 | v4.2.0 发布页 |
|------|------|----------------|
| GitHub | https://github.com/hanye1993/3DPrinterFleetControlWebInterface | [Releases](https://github.com/hanye1993/3DPrinterFleetControlWebInterface/releases/tag/v4.2.0) |
| Gitee | https://gitee.com/hanye11/3DPrinterFleetControlWebInterface | [Releases](https://gitee.com/hanye11/3DPrinterFleetControlWebInterface/releases/tag/v4.2.0) |
| GitCode | https://gitcode.com/hanye6666/3DPrinterFleetControlWebInterface | [Releases](https://gitcode.com/hanye6666/3DPrinterFleetControlWebInterface/releases/tag/v4.2.0) |
...
| **CentOS / RHEL x64** | `centos-4.2.0-amd64.rpm` | `sudo yum install ./centos-4.2.0-amd64.rpm` |
| **CentOS / RHEL arm64** | `centos-4.2.0-arm64.rpm` | 同上 |
| **飞牛 fnOS x86** | `fnos-4.2.0-x86.fpk` | 应用中心先装 **Node.js 20/22**，再手动安装 fpk |
| **飞牛 fnOS ARM** | `fnos-4.2.0-arm.fpk` | 同上 |
| **群晖 x86_64** | `syno-4.2.0-x86_64.spk` | 套件中心先装 **Node.js 20/22**，再手动安装 spk |
| **群晖 aarch64** | `syno-4.2.0-aarch64.spk` | 同上 |
| **安装包源码** | `installer-src-4.2.0.zip` | 各平台打包骨架（`packages-src/`），供二次打包 |
...
1. 右键 `windows-4.2.0-amd64.exe` → **以管理员身份运行**
...
```bash
# Debian / Ubuntu
sudo dpkg -i ubuntu-4.2.0-amd64.deb && sudo apt-get install -f

# CentOS / RHEL / Rocky
sudo yum install ./centos-4.2.0-amd64.rpm
```

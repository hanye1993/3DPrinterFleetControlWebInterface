...
| 平台 | 仓库 | v4.3.1 发布页 |
|------|------|----------------|
| GitHub | https://github.com/hanye1993/3DPrinterFleetControlWebInterface | [Releases](https://github.com/hanye1993/3DPrinterFleetControlWebInterface/releases/tag/v4.3.1) |
| Gitee | https://gitee.com/hanye11/3DPrinterFleetControlWebInterface | [Releases](https://gitee.com/hanye11/3DPrinterFleetControlWebInterface/releases/tag/v4.3.1) |
| GitCode | https://gitcode.com/hanye6666/3DPrinterFleetControlWebInterface | [Releases](https://gitcode.com/hanye6666/3DPrinterFleetControlWebInterface/releases/tag/v4.3.1) |
...
| 平台 | 文件 | 说明 |
|------|------|------|
| **Windows** | `windows-4.3.1-amd64.exe` | 双击安装，可选目录；Win10/11 64 位，需管理员 |
| **macOS Apple Silicon** | `macos-4.3.1-arm64.dmg` | 打开 DMG → 运行 `install.command`（Gitee 单文件 ≤100MB，请从 **GitHub / GitCode** 下载） |
| **macOS Intel** | `macos-4.3.1-amd64.dmg` | 同上 |
| **Ubuntu / Debian x64** | `ubuntu-4.3.1-amd64.deb` / `debian-4.3.1-amd64.deb` | `sudo dpkg -i xxx.deb` |
| **Ubuntu / Debian arm64** | `ubuntu-4.3.1-arm64.deb` / `debian-4.3.1-arm64.deb` | 同上 |
| **CentOS / RHEL x64** | `centos-4.3.1-amd64.rpm` | `sudo yum install ./centos-4.3.1-amd64.rpm` |
| **CentOS / RHEL arm64** | `centos-4.3.1-arm64.rpm` | 同上 |
| **飞牛 fnOS x86** | `fnos-4.3.1-x86.fpk` | 应用中心先装 **Node.js 20/22**，再手动安装 fpk |
| **飞牛 fnOS ARM** | `fnos-4.3.1-arm.fpk` | 同上 |
| **群晖 x86_64** | `syno-4.3.1-x86_64.spk` | 套件中心先装 **Node.js 20/22**，再手动安装 spk |
| **群晖 aarch64** | `syno-4.3.1-aarch64.spk` | 同上 |
| **安装包源码** | `installer-src-4.3.1.zip` | 各平台打包骨架（`packages-src/`），供二次打包 |
...
1. 右键 `windows-4.3.1-amd64.exe` → **以管理员身份运行**
...
```bash
# Debian / Ubuntu
sudo dpkg -i ubuntu-4.3.1-amd64.deb && sudo apt-get install -f
